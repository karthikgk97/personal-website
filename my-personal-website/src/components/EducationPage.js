...
export default function EducationPage() {
    return (
        ...
        <Stack direction="column" justifyContent="flex-start" alignItems="stretch" spacing={2}>
            ...
            <Typography variant="h3" style={{ color: 'rgb(24, 24, 24)', fontFamily: 'Monospace', marginLeft: 15}}> <b> Education </b></Typography>
            <Box>        
            ...
            <Divider light />
            <Typography variant="h3" style={{ color: 'rgb(24, 24, 24)', fontFamily: 'Monospace', marginLeft: 15}}> <b> Experience </b></Typography>
            <Box>        
                {/* <Box sx={{width: '40%', height: '400px', backgroundImage: `url(${asu_logo})`, backgroundRepeat: 'no-repeat', backgroundSize: '100% 100%',}}> */}  
                
                <Typography variant="h4" style={{ display:'flex', alignItems:'center', color: 'rgb(24, 24, 24)', fontFamily: 'Monospace', marginLeft: 15}}> 
                    <Avatar alt="ASU" variant="circular" sizes="small" src={tyson_logo}/>
                    <b> Tyson Foods </b>
                </Typography>
            ...
            <Box>
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={6}>
                    ...
                    <Typography variant="body1" style={{ color: 'rgb(24, 24, 24)', fontFamily: 'Monospace', marginRight: 15}}> <b> June 2019 - Jan 2020</b></Typography>
                </Stack>
            </Box>
        </Stack>
        </>
